...
class MLP:
    ...
    def fit(self, X, y, epochs=1000):
        for epoch in range(epochs):
            ...
            hidden_layer1_output = self._relu(hidden_layer1_input)
            ...
            d_output = error * self._softmax_derivative(output_layer_output)

            error_hidden2_layer = d_output.dot(self.weights_hidden2_output.T)
            d_hidden2_layer = error_hidden2_layer * self._relu_derivative(hidden_layer2_output)

            error_hidden1_layer = d_hidden2_layer.dot(self.weights_hidden1_hidden2.T)
            d_hidden1_layer = error_hidden1_layer * self._relu_derivative(hidden_layer1_output)
